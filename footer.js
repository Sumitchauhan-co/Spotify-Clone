footerPage = document.querySelector(".footer-page");

footerPage.insertAdjacentHTML(
  "afterbegin",
  `
    <div class="container-1">
                ...
                <div class="start">
                    <div class="first">
                        <svg data-encore-id="icon" role="img" aria-hidden="true"
                            class="e-91000-icon e-91000-baseline music-control-glow" viewBox="0 0 16 16"
        ...
        <div class="container-3">
            ...
            <div class="volume-control">
                ...
                <div class="speaker">
                    <svg data-encore-id="icon" role="presentation" aria-label="Volume high" aria-hidden="false"
                        class="e-91000-icon e-91000-baseline" id="volume-icon" viewBox="0 0 16 16"
            ...
            <div class="full-screen">
                ...
                <svg width="16" height="16" class="display-none" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
