let section2PhoneHomePage = document.querySelector(".main .section-2");

section2PhoneHomePage.insertAdjacentHTML(
  "beforeend",
  `
  <div class="homePage-phone display-none">
                <div class="phone-header-container"></div>
                <div class="phone-header">
                    <div class="first-div">All</div>
                    <div class="second-div">Music</div>
                    <div class="third-div">Podcast</div>
                </div>
                <div class="phone-container-class">
                    <div class="playlists-container">
                        ...
                        <div class="div-2">
                            <div class="img"></div>
                            <div class="content">
                                <div class="name">Chill and Relax</div>
                            </div>
                        </div>
                        <div class="div-3">
                            <div class="img"></div>
                    ...
                    <div class="recently-played">
                        ...
                        <div class="content-container">
                            <div class="playlist-1">
                                <div class="img"></div>
                                <div class="content">Chill and Relax</div>
                            </div>
                            <div class="playlist-2">
                                <div class="img"></div>
                                <div class="content">Feelings</div>
                            </div>
                            <div class="playlist-3">
                                <div class="img"></div>
                                <div class="content">Sound Tracks</div>
                            </div>
                            <div class="playlist-4">
                                <div class="img"></div>
                                <div class="content">Best Indian Lofi Hits</div>
                            </div>
                            <div class="playlist-5">
                                <div class="img"></div>
                                <div class="content">Daylist</div>
                            </div>
                        </div>
                    </div>
                    <div class="footer">
