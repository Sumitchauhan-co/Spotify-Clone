...
header.insertAdjacentHTML(
  ...
  `
    <div class="left-header">
            <svg role="img" viewBox="0 0 24 24" class="e-91000-logo e-91000-baseline svg-logo" aria-label="Spotify"
                aria-hidden="false" height="32" data-encore-id="logoSpotify"
        ...
        <div class="mid-header">
            <div class="home-button background-glow">
                <svg data-encore-id="icon" role="img" aria-hidden="true" class="e-91000-icon e-91000-baseline svg-home"
                    viewBox="0 0 24 24">
                    <path
            ...
            <div class="search background-glow">
                <div class="svg-search-container">
                    <svg data-encore-id="icon" role="img" aria-hidden="true"
                        class="e-91000-icon e-91000-baseline M9l40ptEBXPm03dU3X1k svg-search" data-testid="search-icon"
                        viewBox="0 0 24 24"
                ...
                <input class="search-bar" type="text" placeholder="What do you want to play?">
                <div class="line"></div>
                <div class="browse">
                    <svg data-encore-id="icon" role="img" aria-hidden="true"
                        class="e-91000-icon e-91000-baseline svg-browse" viewBox="0 0 24 24">
        ...
        <div class="right-header">
            <div class="premium-button premium-size-grow">
                <span>Explore Premium</span>
            </div>
            <div class="install install-size-grow">
                <svg data-encore-id="icon" role="img" aria-hidden="true"
                    class="e-91000-icon e-91000-baseline svg-install" viewBox="0 0 16 16"
            ...
            <div class="notification backgound-glow">
                <svg data-encore-id="icon" role="img" aria-hidden="true"
                    class="e-91000-icon e-91000-baseline svg-notification dull" viewBox="0 0 16 16"
                    style="--encore-icon-height: var(--encore-graphic-size-decorative-smaller); --encore-icon-width: var(--encore-graphic-size-decorative-smaller);">
                    <path
                        d="M8 1.5a4 4 0 0 0-4 4v3.27a.75.75 0 0 1-.1.373L2.255 12h11.49L12.1 9.142a.75.75 0 0 1-.1-.374V5.5a4 4 0 0 0-4-4m-5.5 4a5.5 5.5 0 0 1 11 0v3.067l2.193 3.809a.75.75 0 0 1-.65 1.124H10.5a2.5 2.5 0 0 1-5 0H.957a.75.75 0 0 1-.65-1.124L2.5 8.569zm4.5 8a1 1 0 1 0 2 0z">
                    </path>
                </svg>
            </div>
            <div class="activity">
                <svg data-encore-id="icon" role="img" aria-hidden="true"
                    class="e-91000-icon e-91000-baseline svg-activity dull" viewBox="0 0 16 16"
                    style="--encore-icon-height: var(--encore-graphic-size-decorative-smaller); --encore-icon-width: var(--encore-graphic-size-decorative-smaller);">
                    <path
